    ...
    var page = {
        ...
        init: function () {
            ...
            page.uploader = WebUploader.create({
                ...
                accept: {
                    extensions: extensions || "doc,docx"
                },
                multiple: true,
            ...
            page.uploader.on('beforeFileQueued', page.beforeFileQueued);
        ...
        beforeFileQueued: function (file) {
            if ($('.lr-form-file-queue-item').length >= 1) {
                learun.alert.error('只允许上传一个文档')
                return false
            }
        },
        ...
        error: function (type) {
            switch (type) {
                case 'Q_TYPE_DENIED':
                    learun.alert.error('只允许上传' + extensions + '文件');
                    break;
            };
        }
    };
