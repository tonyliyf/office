...
namespace Learun.Application.Web.Areas.LR_CodeDemo.Controllers
{
    ...
    /// 描 述：档案管理
    /// </summary>
    public class DC_OA_ArchivesController : MvcControllerBase
    {
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_OA_ArchivesIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dC_OA_ArchivesIBLL.GetTree();
            return Success(data);
        }
        #endregion
        ...
        {
            dC_OA_ArchivesIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
