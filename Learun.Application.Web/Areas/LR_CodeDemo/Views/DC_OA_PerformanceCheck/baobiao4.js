...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#F_CheckStartTime').lrDataSourceSelect({ code: 'GetMonth', value: 'itemvalue', text: 'text' });
            // 刷新 
            ...
            $('#lr-export').on('click', function () {
                learun.download({
                    method: "POST",
                    url: '/LR_CodeDemo/DC_OA_PerformanceCheck/ExportExcel1',
                    param: {
                        fileName: "员工月度绩效考核表",
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_PerformanceCheck/GetPageList3',
                headData: [
                    {
                        label: "责任人", name: "F_CheckUserid", width: 100, align: "left",
                    ...
                    { label: "得分", name: "F_deriveNum", width: 100, align: "left" },
                    { label: "总经理评分", name: "F_GeneralManagerScore", width: 100, align: "left" },
                    { label: "董事长评分", name: "F_ChairmanScore", width: 100, align: "left" },
                    { label: "最终得分", name: "F_JiafenNum", width: 100, align: "left" },
                    { label: "扣分说明", name: "F_RecNumberComments", width: 130, align: "left" },
                    { label: "加分说明", name: "F_AddNumberComments", width: 130, align: "left" },
                ], 
