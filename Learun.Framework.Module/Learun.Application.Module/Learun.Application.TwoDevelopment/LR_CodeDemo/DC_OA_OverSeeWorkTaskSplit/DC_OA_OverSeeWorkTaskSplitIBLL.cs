...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// </summary>
    public interface DC_OA_OverSeeWorkTaskSplitIBLL
    {
        #region 获取数据
        ...
        IEnumerable<DC_OA_OverSeeWorkEntity> GetPageListEx(Pagination pagination, string queryJson);
        /// <summary>
        ...
        #endregion
        void ConnectProcess(string keyValue, string processId);
    }
}
