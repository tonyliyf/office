...
namespace Learun.Application.TwoDevelopment.AssetManager
{
    ...
    /// </summary>
    public interface DC_ASSETS_HouseRentDetailIBLL
    {
        #region 获取数据
        ...
        IEnumerable<DC_ASSETS_HouseRentDetailEntity> GetRentPageList(Pagination pagination, string queryJson);
        IEnumerable<DC_ASSETS_HouseRentDetailEntity> GetRentList(string ids);
        IEnumerable<DC_ASSETS_HouseRentDetailEntity> GetHouseRentDetailInfo(string KeyValue,string SearchValue);
        ...
        /// <summary>
        /// <returns></returns>
        DC_ASSETS_HouseRentDetailEntity GetHouseRentDetailEntity(string keyValue);
        /// <summary>
        /// 获取DC_ASSETS_HouseRentDetail表实体数据
        /// <param name="keyValue">主键</param>
        /// <summary>
        /// <returns></returns>
        DC_ASSETS_HouseRentDetailEntity GetHouseRentDetail(string keyValue);
        ...
        IEnumerable<DC_ASSETS_HouseRentDetail_InfoEntity> GetDC_ASSETS_HouseRentDetailInfoList(string keyValue);
        ...
        /// <summary>
        /// <returns></returns>
        void SaveEntity(string keyValue, DC_ASSETS_HouseRentDetailEntity entity);
