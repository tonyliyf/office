...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      for (var i = 0; i < 35; i++) {
        days.innerHTML = days.innerHTML + '<div class="sc-item"><input class="ycday" type="hidden"/><div class="day"></div><div class="sud lunar-day"></div></div>';
      }
      //添加下拉框数据
    ...
    value: function addData(year, month) {
      ...
      for (var i = 0; i < 35; i++) {
        ...
        if (this._options.showLunarCalendar) {
          ...
          daysElement[i].querySelector('.ycday').value = new LunarHelp(writeyear, writemonth, writeday).getLunarDayName();
        } else {
          daysElement[i].querySelector('.lunar-day').innerHTML = '';
          daysElement[i].querySelector('.ycday').value = '';
      ...
      daysElement.forEach(function (v, i) {
        ...
        if (options.showSolarTerm) {
          if (solarTermdata[currentmonth + '-' + day]) {
            ...
            v.querySelector('.ycday').value = solarTermdata[currentmonth + '-' + day];
        ...
        if (options.showFestival) {
          if (data[currentmonth + '-' + day]) {
            ...
            v.querySelector('.ycday').value = data[currentmonth + '-' + day];
            v.classList.add('sc-festival');
          }
        }
        ...
        if (lunardata && options.showLunarFestival) {
          ...
          if (lunardata[lunar.month + '-' + lunar.day]) {
            ...
            v.querySelector('.ycday').value = lunardata[lunar.month + '-' + lunar.day];
            v.classList.add('sc-festival');
          }
        }
      });
