...
namespace Learun.Application.Web.Areas.ProjectManager.Controllers
{
    ...
    /// </summary>
    public class DC_EngineProject_ProjectTasksProgressController : MvcControllerBase
    {
        private DC_EngineProject_ProjectTasksProgressIBLL dC_EngineProject_ProjectTasksProgressIBLL = new DC_EngineProject_ProjectTasksProgressBLL();
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_EngineProject_ProjectTasksProgressIBLL.ExportData(queryJson);
            //行数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_EngineProject_ProjectTasksProgressIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var DC_EngineProject_ProjectTasksProgressData = dC_EngineProject_ProjectTasksProgressIBLL.GetDC_EngineProject_ProjectTasksProgressEntity( keyValue );
            var jsonData = new {
                DC_EngineProject_ProjectTasksProgress = DC_EngineProject_ProjectTasksProgressData,
            };
            return Success(jsonData);
        }
        ...
        {
            var data = dC_EngineProject_ProjectTasksProgressIBLL.GetTree();
            return Success(data);
        }
        #endregion
        ...
        {
            dC_EngineProject_ProjectTasksProgressIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
        ...
        {
            DC_EngineProject_ProjectTasksProgressEntity entity = strEntity.ToObject<DC_EngineProject_ProjectTasksProgressEntity>();
            dC_EngineProject_ProjectTasksProgressIBLL.SaveEntity(keyValue,entity);
            return Success("保存成功！");
        }
        #endregion
