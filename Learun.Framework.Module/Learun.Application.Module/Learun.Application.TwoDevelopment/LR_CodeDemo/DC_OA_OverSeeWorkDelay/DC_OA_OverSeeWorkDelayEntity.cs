...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// </summary>
    public class DC_OA_OverSeeWorkDelayEntity 
    {
        #region 实体成员
        /// <summary>
        /// 主键
        /// </summary>
        [Column("F_OSWDID")]
        public string F_OSWDId { get; set; }
        /// <summary>
        /// 督查督办工作表主键
        /// </summary>
        [Column("F_OSWID")]
        ...
        /// 申请办结时间
        /// </summary>
        [Column("F_ENDDELAYDATE")]
        public DateTime? F_EndDelayDate { get; set; }
        /// <summary>
        /// 申请延期说明
        /// </summary>
        [Column("F_DELAYEXPLAIN")]
        public string F_DelayExplain { get; set; }
        #endregion
