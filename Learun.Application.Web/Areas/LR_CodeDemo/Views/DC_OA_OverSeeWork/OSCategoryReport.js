...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_OverSeeWork/StatisticsByCategory',
                headData: [
                    { name: "state", label: "执行状态", width: 100, align: "center" },
                    { name: "type", label: "工作类型", width: 100, align: "center" },
        ...
        search: function (param) {
            ...
            $.post('StatisticsByCategoryEx',  param, function (data) {
