...
namespace Learun.Application.Web.Areas.ProjectManager.Controllers
{
    ...
    /// </summary>
    public class DC_EngineProject_ProjectExaminationSuperviseController : MvcControllerBase
    {
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_EngineProject_ProjectExaminationSuperviseIBLL.ExportData(queryJson);
            //行数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_EngineProject_ProjectExaminationSuperviseIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = dC_EngineProject_ProjectExaminationSuperviseIBLL.GetTree();
            return Success(data);
        }
        #endregion
        ...
        {
            DC_EngineProject_ProjectExaminationSuperviseEntity entity = strEntity.ToObject<DC_EngineProject_ProjectExaminationSuperviseEntity>();
            dC_EngineProject_ProjectExaminationSuperviseIBLL.SaveEntity(keyValue,entity);
            return Success("保存成功！");
        }
        #endregion
