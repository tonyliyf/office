...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            ...
            if (keyValue) {
                $.lrSetForm(top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseInfo/GetFormData?keyValue=' + keyValue, function (data) {
                    var center = JSON.parse(data.DC_ASSETS_HouseInfo.F_CenterpointCoordinates)
                    marker = new AMap.Marker({
                        position: center,
                        map: map
                    });
