...
namespace Learun.Application.TwoDevelopment.LR_CodeDemo
{
    ...
    /// 描 述：会议室管理
    /// </summary>
    public class MeetingRoomBLL : MeetingRoomIBLL
    {
        ...
        public IEnumerable<DC_OA_MeetingRoomEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return meetingRoomService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public DC_OA_MeetingRoomEntity GetDC_OA_MeetingRoomEntity(string keyValue)
        {
            try
            {
                return meetingRoomService.GetDC_OA_MeetingRoomEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                meetingRoomService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, DC_OA_MeetingRoomEntity entity)
        {
            try
            {
                meetingRoomService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        List<FullcalendarResult> MeetingRoomIBLL.GetMeettingData(string keyValue)
        {
            try
            {
                return meetingRoomService.GetMeettingData(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
