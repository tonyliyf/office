...
namespace Learun.Application.Web.Areas.ProjectManager.Controllers
{
    ...
    /// </summary>
    public class DC_EngineProject_ProjectTasksController : MvcControllerBase
    {
        private DC_EngineProject_ProjectTasksIBLL dC_EngineProject_ProjectTasksIBLL = new DC_EngineProject_ProjectTasksBLL();
        ...
        [HttpGet]
        public ActionResult ProjectTaskIndex()
        {
            return View();
        }
        #endregion
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_EngineProject_ProjectTasksIBLL.ExportData(queryJson);
            //行数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_EngineProject_ProjectTasksIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var DC_EngineProject_ProjectTasksData = dC_EngineProject_ProjectTasksIBLL.GetDC_EngineProject_ProjectTasksEntity(keyValue);
            var jsonData = new
            {
                DC_EngineProject_ProjectTasks = DC_EngineProject_ProjectTasksData,
            };
            return Success(jsonData);
        }
        #endregion
        ...
        {
            dC_EngineProject_ProjectTasksIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
        ...
        {
            DC_EngineProject_ProjectTasksEntity entity = strEntity.ToObject<DC_EngineProject_ProjectTasksEntity>();
            dC_EngineProject_ProjectTasksIBLL.SaveEntity(keyValue, entity);
            return Success("保存成功！");
        }
        #endregion
        ...
        {
            return Json(dC_EngineProject_ProjectTasksIBLL.GetGanttData(keyValue));
        }
    }
}
