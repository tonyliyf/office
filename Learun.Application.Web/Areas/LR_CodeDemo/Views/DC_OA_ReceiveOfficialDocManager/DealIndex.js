    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#processState').lrselect({
                url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_ReceiveOfficialDocManager/GetProcessStep',
                value: 'key',
                text: 'value'
            })
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_ReceiveOfficialDocManager/GetDealIndexPageList',
                headData: [
                    { label: "来文单位", name: "department", width: 200, align: "center" },
                    { label: "收文号", name: "code", width: 125, align: "center" },
                    { label: "文件字号", name: "filecode", width: 386, align: "center" },
                    {
                        label: "收文时间", name: "date", width: 208, align: "center", formatterAsync: function (callback, value, row, op, $cell) {
                            if (value.length <= 10) {
                                callback(value);
                            } else {
