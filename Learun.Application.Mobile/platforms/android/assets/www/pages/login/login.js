    ...
    var page = {
        ...
        init: function ($page) {
            $page.find('#loginBtn').on('tap', function () {
                ...
                if (account === "") {
                    learun.layer.warning('用户名不能为空！', function () { }, '框架提示', '关闭');
                } else if (password === "") {
                    learun.layer.warning('密码不能为空！', function () { }, '框架提示', '关闭');
                } else {
                    var data = {
                        username: account,
                    ...
                    learun.http.post(path + "learun/adms/user/login", postdata, (res) => {
                        ...
                        if (res === null) {
                            learun.layer.warning('无法连接服务器,请检测网络！', function () { }, '框架提示', '关闭');
                            return;
                        }
                        ...
                        if (res.code === 200) {
                            ...
                            learun.layer.warning(res.info, function () { }, '框架提示', '关闭');
                        }
                    });
                } 
            });
