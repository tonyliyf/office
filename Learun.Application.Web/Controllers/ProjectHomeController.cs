...
namespace Learun.Application.Web.Controllers
{
    ...
    /// 描 述：主页控制器
    /// </summary>
    public class ProjectHomeController : MvcControllerBase
    {
        private reportIBLL report = new reportBLL();
        private DC_EngineProject_ProjectInfoIBLL projectBll = new DC_EngineProject_ProjectInfoBLL();
        #region 视图功能
        /// <summary>
        /// 初始化页面
        /// </summary>
       ...
       [HttpGet]
        public ActionResult GetProjectInfo(string F_ProjectAddress)
        {
            return Success(projectBll.GetProjectInfo(F_ProjectAddress));
        }


        [HttpGet]
        public ActionResult GetProjectContractInfo(string projectid)
        {
            return Success(projectBll.GetProjectContract1(projectid));
        }
