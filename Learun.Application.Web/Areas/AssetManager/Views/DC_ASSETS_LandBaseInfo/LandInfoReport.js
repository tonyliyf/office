...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_LandBaseInfo/StatisticsLandInfoByArea',
                headData: [
                    { name: "areaname", label: "行政区域", width: 100, align: "center" },
                    { name: "count", label: "宗地数量", width: 100, align: "center" },
                    { name: "area", label: "面积", width: 100, align: "center" },
                    { name: "amount", label: "出让金", width: 100, align: "center" },
                ],
                reloadSelected: true,
                //mainId: 'billNo'
            });
        ...
        search: function (param) {
            ...
            $.post('StatisticsLandInfoByAreaEx', param, function (data) {
