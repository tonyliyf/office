...
namespace Learun.Util
{
    ...
    public static class DirFileHelper
    {
...

        {
            ...
            string virtualPath = HttpContext.Current.Server.MapPath(System.Web.HttpContext.Current.Request.ApplicationPath.ToString());//获取程序根目录
        ...
        // d:/oaSystem/doc/fileAnnexes/System/20191113/0d706474-676a-41f6-80ee-dd21489c61d8.jpg
        #endregion
        ...
        public static void ClearObservateDirectory(string directoryPath)
        {
