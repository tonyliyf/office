        ...
        initGrid: function () {
            $('#gridtable').jfGrid({
                ...
                headData: [
                    ...
                    {
                        label: '所负责子公司', name: 'F_ManageCompanyNames', width: 300, align: 'center'
                    },
                    {
                        label: '所负责集团部门', name: 'F_ManageDeptNames', width: 300, align: 'center'
                    },
                    {
                        label: '创建时间', name: 'F_CreateDate', width: 130, align: 'center', formatterAsync: function (callback, value, row, op, $cell) {
                            if (value.length <= 10) {
                                callback(value);
                            } else {
                    ...
                    {
                        label: '角色层级', name: 'F_Level', width: 80, align: 'center'
                    },
                    {
                    ...
                    { label: "角色描述", name: "F_Description", index: "F_Description", width: 100, align: "left" }
                ],
                isPage: true,
                reloadSelected: true,
                mainId: 'F_RoleId'
