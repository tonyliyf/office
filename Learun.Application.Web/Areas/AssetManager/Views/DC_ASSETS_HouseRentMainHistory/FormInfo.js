...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        //    $('#DC_ASSETS_HouseRentDetai_InfoHistory').jfGrid({
        //        headData: [
        ...
        initData: function () {
            ...
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentDetaiHistory/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strEntity = JSON.stringify($('[data-table="DC_ASSETS_HouseRentDetaiHistory"]').lrGetFormData());
      //  postData.strdC_ASSETS_HouseRentDetailInfoList = JSON.stringify(entity);
        $.lrSaveForm(top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentDetaiHistory/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
