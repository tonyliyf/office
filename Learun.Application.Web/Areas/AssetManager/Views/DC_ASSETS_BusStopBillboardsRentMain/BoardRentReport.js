...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_BusStopBillboardsRentMain/StatisticsRent',
                headData: [
                    { name: "month", label: "月度", width: 100, align: "center" },
                    { name: "money", label: "租金", width: 100, align: "center" }
                ],
                reloadSelected: true,
                //mainId: 'billNo'
            });
        ...
        search: function (param) {
            ...
            $.post('StatisticsRentEx', param, function (data) {
