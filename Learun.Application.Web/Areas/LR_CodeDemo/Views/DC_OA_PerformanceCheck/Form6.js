...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            var now = new Date()
            $('#i1').val(now.getFullYear())
            $('#i2').val(now.getFullYear())
            $('#i3').val(1)
            $('#i4').val(1)
            $('#i5').val(12)
            $('#i6').val(31)
    ...
    acceptClick = function (callBack) {
        ...
        var nYear = parseInt(tableData.inputData.i2);
        var nMonth = parseInt(tableData.inputData.i3);
        var nDay = parseInt(tableData.inputData.i4);
        var _nMonth = parseInt(tableData.inputData.i5);
        var _nDay = parseInt(tableData.inputData.i6);
        ...
        var postData = {
            strEntity: JSON.stringify({
                ...
                F_CheckNumber: (role == 2 ? +$('#t13').text() : 0)
            })
        };
