...
namespace Learun.Application.Web.Areas.ProjectManager.Controllers
{
    ...
    /// </summary>
    public class DC_EngineProject_ConstructionRecordController : MvcControllerBase
    {
        private DC_EngineProject_ConstructionRecordIBLL dC_EngineProject_ConstructionRecordIBLL = new DC_EngineProject_ConstructionRecordBLL();
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_EngineProject_ConstructionRecordIBLL.ExportData(queryJson);
            //行数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_EngineProject_ConstructionRecordIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var DC_EngineProject_ConstructionRecordData = dC_EngineProject_ConstructionRecordIBLL.GetDC_EngineProject_ConstructionRecordEntity( keyValue );
            var jsonData = new {
                DC_EngineProject_ConstructionRecord = DC_EngineProject_ConstructionRecordData,
            };
            return Success(jsonData);
        }
        #endregion
        ...
        {
            dC_EngineProject_ConstructionRecordIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
        ...
        {
            DC_EngineProject_ConstructionRecordEntity entity = strEntity.ToObject<DC_EngineProject_ConstructionRecordEntity>();
            dC_EngineProject_ConstructionRecordIBLL.SaveEntity(keyValue,entity);
            return Success("保存成功！");
        }
        #endregion
