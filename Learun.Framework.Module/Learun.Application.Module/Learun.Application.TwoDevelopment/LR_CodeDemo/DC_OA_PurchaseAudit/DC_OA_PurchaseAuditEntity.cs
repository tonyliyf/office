...

{
    ...
    /// </summary>
    public class DC_OA_PurchaseAuditEntity 
    {
        #region 实体成员
        /// <summary>
        /// 主键
        /// </summary>
        /// <returns></returns>
        [Column("F_PURCHASEAUDITID")]
        public string F_PurchaseAuditId { get; set; }
        /// <summary>
        /// 经办人联系电话
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        [Column("F_PURCHASEREPLYREFID")]
        public string F_PurchaseReplyRefid { get; set; }
        /// <summary>
        /// 采购公司
        /// </summary>
        /// <returns></returns>
        [Column("F_CURRENTCOMPAYNAME")]
        public string F_CurrentCompayName { get; set; }
        /// <summary>
        /// 采购部门
        /// </summary>
        /// <returns></returns>
        ...
        public void Create()
        {
            this.F_PurchaseAuditId = Guid.NewGuid().ToString();
        ...
        {
            this.F_PurchaseAuditId = keyValue;
