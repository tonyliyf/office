/*
 * 版 本 Learun-ADMS V6.1.6.0 敏捷开发框架(http://www.learun.cn)
            ...
            $('#lr-share').on('click', function () {
                ...
                if (keyValue) {
                    learun.layerConfirm("注：您确定要共享此" + (fileType == "folder" ? "文件夹" : "文件") + "吗？", function (res) {
                        if (res) {
                            learun.postForm(top.$.rootUrl + '/LR_OAModule/ResourceFile/ShareFile', { keyValue: keyValue, IsShare: 1, fileType: fileType }, function () {
                                refreshGirdData();
                            });
                        }
                    });
