...
namespace Learun.Application.TwoDevelopment.AssetManager
{
    ...
    /// </summary>
    public class DC_ASSETS_BuildingBaseInfoEntity
    {
        #region 实体成员
        /// <summary>
        /// 主键
        ...
        public double? F_ConstructionHeight { get; set; }
        /// <summary>
        /// 建筑层数
        /// </summary>
        ...
        /// </summary>
        [NotMapped]
        public string F_PictureAccessories_building { get; set; }
        /// <summary>
        /// 其他附件
        /// </summary>
        [NotMapped]
        public string F_OtherAccessories_building { get; set; }
        #endregion
