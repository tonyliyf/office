...
(function ($, learun) {
    ...
    var page = {
        init: function () {
            ...
            // 打开首页模板
            learun.frameTab.open({ F_ModuleId: '0', F_Icon: 'fa fa-desktop', F_FullName: '我的桌面', F_UrlAddress: '/Projecthome/AdminDesktop' }, true);
        ...
        loginout: function () { // 安全退出
            learun.layerConfirm("注：您确定要安全退出本次登录吗？", function (r) {
                if (r) {
                    ...
                    learun.httpAsyncPost($.rootUrl + '/Projectlogin/OutLogin', {}, function (data) {
                        window.location.href = $.rootUrl + "/Projectlogin/Index";
                    });
                }
            });
        },
        clearredis: function () {
            learun.layerConfirm("注：您确定要清空全部后台缓存数据吗？", function (r) {
                if (r) {
                    ...
                    learun.httpAsyncPost($.rootUrl + '/ProjectHome/ClearRedis', {}, function (data) {
                        window.location.href = $.rootUrl + "/projectLogin/Index";
                    });
                }
            });
        ...
        // 皮肤主题设置
        uitheme: function () {
            var uitheme = top.$.cookie('Learn_ADMS_V6.1_UItheme1') || '1';
            ...
            $setting.find('input').click(function () {
                var value = $(this).val();
                top.$.cookie('Learn_ADMS_V6.1_UItheme1', value, { path: "/" });
                location.reload();
            });
