        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '新增',
                    url: top.$.rootUrl + '/AssetManager/DC_ASSETS_BuildingBaseInfo/Form',
                    width: 600,
                    height: 570,
            ...
            $('#lr-export1').on('click', function () {
                ...
                learun.download({
                    method: "POST",
                    url: top.$.rootUrl + '/AssetManager/DC_ASSETS_BuildingBaseInfo/ExportExcel',
                    param: {
                        fileName: "建筑信息表",
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑',
                        url: top.$.rootUrl + '/AssetManager/DC_ASSETS_BuildingBaseInfo/Form?keyValue=' + keyValue,
                        width: 600,
                        height: 570,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_file1').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    ...
                    top.learun.frameTab.open({
                        F_ModuleId: FIDS, F_Icon: '',
                        F_FullName: '图片查看', F_UrlAddress: '/LR_CodeDemo/FileViewer/ImageViewer?FIDS=' + FIDS + ',' + FIDS1
                    });
                }
            })
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                ...
                dblclick: function (rowdata) {
                    $('#ifr1').attr('src', '../DC_ASSETS_HouseInfo/Index?keyValue=' + rowdata.F_BBIId)
                    $('#ifr2').attr('src', './MapForm?look=1&keyValue=' + rowdata.F_BBIId)
                }
