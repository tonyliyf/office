...
namespace Learun.Application.Web.Areas.LR_OAModule.Controllers
{
    ...
    public class ResourceFileController : MvcControllerBase
    {
        ...
        public void PreviewFile(string fileId)
        {
            ...
            FileConvertoPdfUtil.PreviewFile(filepath, data.F_FileType);
            ...
            //        Workbook wb = new Workbook(oldpath);

            //        wb.Save(filepath.Substring(0, oldpath.LastIndexOf(".")) + ".pdf", SaveFormat.Pdf);
            //    }
            //}
            ...
            //    {
            //        //添加word转pdf格式
            //        filePreviewIBLL.GetWordDataByAspose(DirFileHelper.GetAbsolutePath(data.F_FilePath));
            //    }
            //}
            ////FileDownHelper.DownLoadold(filepath, filename);
