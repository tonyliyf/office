...
(function ($, learun) {
    ...
    var page = {
        init: function () {
            ...
            // 打开首页模板
            learun.frameTab.open({ F_ModuleId: '0', F_Icon: 'fa fa-desktop', F_FullName: '我的桌面', F_UrlAddress: '/Portal/AdminDesktop1' }, true);
        ...
        userInit: function () {
          ...
          //  _html += '<li><a href="javascript:void(0);" id="lr_schedule_btn"><i class="fa fa-calendar"></i><span>我的日程</span></a></li>';
            ...
            _html += '</ul></div>';
            $('body').append(_html);
//          $("body").append("<input type='hidden' class='ysud' value='"+loginInfo.realName+"' />")
            // 语言包翻译
