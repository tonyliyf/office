...
namespace Learun.Application.Web.Areas.AssetManager.Controllers
{
    ...
    /// </summary>
    public class DC_ASSETS_HouseRentMainHistoryController : MvcControllerBase
    {
        private DC_ASSETS_HouseRentMainHistoryIBLL dC_ASSETS_HouseRentMainIBLL = new DC_ASSETS_HouseRentMainHistoryBLL();
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_ASSETS_HouseRentMainIBLL.ExportData1(queryJson);
            //行数据
        ...
        public ActionResult GetFormData(string keyValue)
        {
            ...
            var jsonData = new
            {
                DC_ASSETS_HouseRentMainHistory = DC_ASSETS_HouseRentMainData,
                DC_ASSETS_HouseRentDetailHistory = DC_ASSETS_HouseRentDetailData,
            };
            return Success(jsonData);
        }
        #endregion
        ...
        {
            DC_ASSETS_HouseRentMainHistoryEntity entity = strEntity.ToObject<DC_ASSETS_HouseRentMainHistoryEntity>();
            //List<DC_ASSETS_HouseRentDetaiHistoryEntity> dC_ASSETS_HouseRentDetailList = strdC_ASSETS_HouseRentDetailList.ToObject<List<DC_ASSETS_HouseRentDetaiHistoryEntity>>();
        ...
        public ActionResult Import(string keyValue)
        {
            ...
            dC_ASSETS_HouseRentMainIBLL.ImportRent(dt);
