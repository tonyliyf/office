...
namespace Learun.Application.Web.Controllers
{
    ...
    public class AssetLoginController : MvcControllerBase
    {
        #region 模块对象
        ...
        public ActionResult Index(string userid)
        {
            ...
            // HttpCookie cookie = Request.Cookies["loginidweaver"];
            ...
            if (!userid.IsEmpty())
            {
                ...
                userEntity = userBll.CheckLogin(userid);
                ...
                else
                {
                    ...
                    logEntity.F_OperateAccount = userEntity.F_CreateUserName;
                    logEntity.F_ExecuteResultJson = "登录成功:" + oaid;
                    logEntity.WriteLog();//写入日志
                    //logEntity.F_ExecuteResult = 1;
                    //logEntity.F_ExecuteResultJson = "登录成功";
                    //logEntity.WriteLog();
                    //logEntity.F_ExecuteResult  = 0;
                    //logEntity.F_ExecuteResultJson = "loginidweaver没有泛微登陆的cookie信息";
                    //logEntity.WriteLog();
                    return RedirectToAction("Index", "AssetHome");
                }
            }
