...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/GetFormData?keyValue=' + keyValue, function (data) {
                    for (var id in data) {
    ...
    acceptClick = function (callBack) {
        ...
        postData.strEntity = JSON.stringify($('[data-table="DC_ASSETS_HouseRentMainHistory"]').lrGetFormData());
       // postData.strdC_ASSETS_HouseRentDetailList = JSON.stringify(entity);
        $.lrSaveForm(top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/SaveForm2?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
