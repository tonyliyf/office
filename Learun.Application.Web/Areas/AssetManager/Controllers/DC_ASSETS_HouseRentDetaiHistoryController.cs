...
namespace Learun.Application.Web.Areas.AssetManager.Controllers
{
    ...
    /// </summary>
    public class DC_ASSETS_HouseRentDetaiHistoryController : MvcControllerBase
    {
        ...
        private DC_ASSETS_HouseRentDetaiHistoryBLL dC_ASSETS_HouseRentDetailHistoryIBLL = new DC_ASSETS_HouseRentDetaiHistoryBLL();
        private DC_ASSETS_HouseRentMainHistoryBLL DC_ASSETS_HouseRentMainHistoryIBLL1 = new DC_ASSETS_HouseRentMainHistoryBLL();
        #region 视图功能
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_ASSETS_HouseRentDetailHistoryIBLL.GetRentPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        public ActionResult GetRentPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_ASSETS_HouseRentDetailHistoryIBLL.GetRentPageList(paginationobj, queryJson);
            List<DC_ASSETS_HouseRentDetaiHistoryEntity> list = new List<DC_ASSETS_HouseRentDetaiHistoryEntity>();
        ...
        public ActionResult GetFormData(string keyValue)
        {
            ...
            var DC_ASSETS_HouseRentDetailData = dC_ASSETS_HouseRentDetailHistoryIBLL.GetHouseRentDetailEntity(keyValue);
            //var DC_ASSETS_HouseRentDetailData_infoData = dC_ASSETS_HouseRentDetailHistoryIBLL.GetDC_ASSETS_HouseRentDetailInfoList(keyValue);
            var DC_ASSETS_HouseRentMainHistory = DC_ASSETS_HouseRentMainHistoryIBLL1.GetDC_ASSETS_HouseRentMainEntity(DC_ASSETS_HouseRentDetailData.F_HRMId);
            DC_ASSETS_HouseRentDetailData.F_RentName = DC_ASSETS_HouseRentMainHistory.F_RentName;
               var jsonData = new
            {
                DC_ASSETS_HouseRentDetaiHistory = DC_ASSETS_HouseRentDetailData
        ...
        {
            var data = dC_ASSETS_HouseRentDetailHistoryIBLL.GetTree();
            return Success(data);
        }
        #endregion
        ...
        {
            DC_ASSETS_HouseRentDetaiHistoryEntity entity = strEntity.ToObject<DC_ASSETS_HouseRentDetaiHistoryEntity>();

            dC_ASSETS_HouseRentDetailHistoryIBLL.SaveEntity(keyValue, entity);
            return Success("保存成功！");
        }
