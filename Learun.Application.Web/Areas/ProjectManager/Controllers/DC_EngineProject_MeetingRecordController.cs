...
namespace Learun.Application.Web.Areas.ProjectManager.Controllers
{
    ...
    /// </summary>
    public class DC_EngineProject_MeetingRecordController : MvcControllerBase
    {
        ...
        public void ExportExcel(string queryJson, string fileName, string exportField, string columnJson)
        {
            ...
            var dt = dC_EngineProject_MeetingRecordIBLL.ExportData(queryJson);
            //行数据
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = dC_EngineProject_MeetingRecordIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        public ActionResult SaveForm(string keyValue, string strEntity)
        {
            ...
            {
                iBll.UseRuleSeed("MeetingRecordNum");
            }
            DC_EngineProject_MeetingRecordEntity entity = strEntity.ToObject<DC_EngineProject_MeetingRecordEntity>();
            dC_EngineProject_MeetingRecordIBLL.SaveEntity(userInfo,keyValue,entity);
            return Success("保存成功！");
        }
        #endregion
