...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initGrid: function () {
            ...
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseInfo/StatisticsHouseInfo',
                headData: [
                    { name: "areaname", label: "行政区域", width: 100, align: "center" },
                    { name: "type", label: "房屋使用性质", width: 100, align: "center" },
                    { name: "count", label: "房屋数量", width: 100, align: "center" },
        ...
        search: function (param) {
            ...
            $.post('StatisticsHouseInfoEx', param, function (data) {
