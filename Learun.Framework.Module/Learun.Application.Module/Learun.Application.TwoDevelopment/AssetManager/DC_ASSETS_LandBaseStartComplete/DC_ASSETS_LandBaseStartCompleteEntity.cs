...
namespace Learun.Application.TwoDevelopment.AssetManager
{
    ...
    /// </summary>
    public class DC_ASSETS_LandBaseStartCompleteEntity 
    {
        #region 实体成员
        /// <summary>
        /// 主键
        /// </summary>
        [Column("F_LBSCID")]
        public string F_LBSCId { get; set; }
        /// <summary>
        /// 土地基本信息主键
        /// </summary>
        [Column("F_LBIID")]
        ...
        /// <summary>
        /// 开工竣工状态,取数据字典，如约定开工、开工、竣工
        /// </summary>
        [Column("F_STARTCOMPLETESTATE")]
        public string F_StartCompleteState { get; set; }
        /// <summary>
        /// 日期
        /// </summary>
        [Column("F_HANDLEDATE")]
        ...
        public void Create()
        {
            this.F_LBSCId = Guid.NewGuid().ToString();
