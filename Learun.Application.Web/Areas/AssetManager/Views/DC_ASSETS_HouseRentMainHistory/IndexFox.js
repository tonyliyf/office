...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 初始化左侧树形数据
            $('#dataTree').lrtree({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentDetaiHistory/GetTree',
            ...
            $('#lr-export1').on('click', function () {
                ...
                learun.download({
                    method: "POST",
                    url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/ExportExcel',
                    param: {
                        fileName: "招租批次信息表",
            ...
            $('#lr_Editcategory').on('click', function () {
                ...
                if (keyValue == 0 || keyValue == '' || keyValue.length < 20) {
                    ...
                    learun.layerForm({
                        id: 'form',
                        title: '编辑招租计划',
                        url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/Form2?keyValue=' + keyValue,
                        width: 1200,
                        height: 560,
            ...
            $('#lr_edit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'form',
                        title: '编辑',
                        url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/FormInfo?keyValue=' + keyValue,
                        width: 1200,
                        height: 560,
                        callBack: function (id) {
                            return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_importplan').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '导入',
                    url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentMainHistory/ExcelImportPlan',
                    width: 600,
                    height: 250,
                    callBack: function (id) {
                        return top[id].acceptClick(refreshGirdData);
            ...
            $('#lr_file').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    ...
                    top.learun.frameTab.open({
                        ...
                        F_FullName: '附件信息查看', F_UrlAddress: '/LR_CodeDemo/FileViewer/Index?FIDS=' + FIDS + ',' + F_HRMId
                    });
                }
            })
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_HouseRentDetaiHistory/GetRentPageList',
                headData: [
                    { label: "招租名称", name: "F_RentName", width: 100, align: "center" },
                    { label: "所有权人", name: "F_Unit", width: 150, align: "center" },
                    ...
                    { label: "租赁人", name: "F_Renter", width: 150, align: "center" },
                    { label: "租赁人电话", name: "F_RenterPhone", width: 150, align: "center" },
                    {
