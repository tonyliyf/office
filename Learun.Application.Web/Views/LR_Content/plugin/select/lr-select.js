 ...
 * Copyright (c) 2013-2018 力 软信息技术有限公司
 * 创建人：力 软-前端开发组
 * 日 期：2017.03.22
            ...
            if (dfop.isload == false) {
                ...
                switch (dfop.type) {
                    ...
                    case 'multiple':
                        ...
                        dfop.multipleText = [];
                        if (dfop.isrender) {
                            $('#learun_select_option_' + dfop.id).find('.lr-select-node-cb[src$="checkbox_1.png"]').attr('src', '/Content/images/learuntree/checkbox_0.png');
                        }
                        ...
                        for (var i = 0, l = dfop.data.length; i < l; i++) {
                            ...
                            if (_arrayIndex != -1) {
                                ...
                                if (dfop.isrender) {
                                    $('#learun_select_option_' + dfop.id).find('[data-value="' + i + '"] .lr-select-node-cb').attr('src', '/Content/images/learuntree/checkbox_1.png');
                                }
                                if (dfop.select) {
