...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                learun.layerForm({
                    id: 'form',
                    title: '新增',
                    url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_PerformanceUserWorkInterview/Form1?F_CheckUserid=' + F_CheckUserid + '&F_CheckUserDeptId=' + F_CheckUserDeptId,
                    width: 600,
                    height: 500,
            ...
            b = function (data1, data2) {
              
                F_CheckUserid = data1;
                F_CheckUserDeptId = data2;
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                ...
                headData: [
                    ...
                    {
                        label: "被面谈人姓名", name: "F_BeInterviewUser", width: 100, align: "left",
                        formatterAsync: function (callback, value, row, op, $cell) {
                    ...
                    { label: "上周绩效情况", name: "F_InterviewContentA", width: 350, align: "left" },
                    { label: "考核周期成绩", name: "F_InterviewContentB", width: 350, align: "left" },
                    { label: "考核周期工作改进方案", name: "F_InterviewContentC", width: 350, align: "left" },
                    {
        ...
        search: function (param) {
            ...
            param.F_BeInterviewUser = F_CheckUserid;
