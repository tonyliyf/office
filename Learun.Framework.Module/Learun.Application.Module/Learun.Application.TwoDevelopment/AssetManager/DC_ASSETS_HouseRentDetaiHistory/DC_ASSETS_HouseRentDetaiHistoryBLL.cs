...
namespace Learun.Application.TwoDevelopment.AssetManager
{
    ...
    /// </summary>
    public class DC_ASSETS_HouseRentDetaiHistoryBLL : DC_ASSETS_HouseRentDetaiHistoryIBLL
    {
        private DC_ASSETS_HouseRentDetaiHistoryService dC_ASSETS_HouseRentDetailService = new DC_ASSETS_HouseRentDetaiHistoryService();
        ...
        public IEnumerable<DC_ASSETS_HouseRentDetailEntity> GetRentDetailinfo(string keyValue, string SearchValue)
        {
            ...
            try
            {
                return dC_ASSETS_HouseRentDetailService.GetRentDetailinfo(keyValue,SearchValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public List<TreeModel> GetTree()
        {
            try
            {
                ...
                {
                    if (item["id"].ToString() == ""|| item["name"].ToString()=="")
                    {
                        continue;
                    }
