...
(function ($, learun) {
    ...
    var page = {
        init: function () {
            ...
            // 打开首页模板
            learun.frameTab.open({ F_ModuleId: '0', F_Icon: 'fa fa-desktop', F_FullName: '我的桌面', F_UrlAddress: '/assethome/AdminDesktop' }, true);
        ...
        loginout: function () { // 安全退出
            learun.layerConfirm("注：您确定要安全退出本次登录吗？", function (r) {
                if (r) {
                    ...
                    learun.httpAsyncPost($.rootUrl + '/AssetLogin/OutLogin', {}, function (data) {
                        window.location.href = $.rootUrl + "/AssetLogin/Index";
                    });
                }
            });
        },
        clearredis: function () {
            learun.layerConfirm("注：您确定要清空全部后台缓存数据吗？", function (r) {
                if (r) {
                    ...
                    learun.httpAsyncPost($.rootUrl + '/assetHome/ClearRedis', {}, function (data) {
                        window.location.href = $.rootUrl + "/AssetLogin/Index";
                    });
                }
            });
