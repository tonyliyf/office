...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            $.get(top.$.rootUrl + '/LR_CodeDemo/DC_OA_OverSeeWork/GetCount',function(res){
            ...
            $('#lr_taskSplit').on('click', function () {
                ...
                if (learun.checkrow(keyValue)) {
                    ...
                    learun.layerForm({
                        id: 'form',
                        title: '任务项',
                        url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_OverSeeWorkTaskSplitDelete/Index?keyValue=' + keyValue,
                        width: 1800,
                        height: 600,
                        btn: null,
                        end: function (id) {
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/LR_CodeDemo/DC_OA_OverSeeWorkTaskSplit/GetPageList',
                               headData: [
                    {
