...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            var url = top.$.rootUrl + '/LR_CodeDemo/DC_OA_PerformanceRecordRun/GetUserList?tid=' + tid
            ...
            $.lrSetForm(top.$.rootUrl + '/LR_CodeDemo/DC_OA_PerformanceRecordRun/GetUserIdList?rid=' + rid, function (data) {
                if (data.userIds == "") {
                    return false;
                }
                var $warp = $('#selected_user_list');
    ...
    acceptClick = function () {
        $.lrSaveForm(top.$.rootUrl + '/LR_CodeDemo/DC_OA_PerformanceRecordRun/SaveUserList', { rid: rid, userIds: String(userlistselected) }, function (res) { });
        return true;
    };
    page.init();
}