...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initGird: function () {
            $('#gridtable').jfGrid({
                url: top.$.rootUrl + '/AssetManager/DC_ASSETS_LandBaseInfo/GetPageList?type=1',
                headData: [
                    { label: "原单位", name: "F_Transferor", width: 150, align: "center" },
                    { label: "土地名称", name: "F_LandName", width: 150, align: "center" },
                    { label: "资产编号", name: "F_AssetsNumber", width: 130, align: "center" },
                    { label: "受让人", name: "F_Assignee", width: 130, align: "center" },
                    { label: "土地证号", name: "F_LandCertificate", width: 120, align: "center" },
                   { label: "宗地编号", name: "F_LandNumber", width: 80, align: "center" },
                    { label: "面积", name: "F_Area", width: 80, align: "center" },
                    {
                        label: "使用性质", name: "F_LandUseNature", width: 80, align: "center",
                    ...
                    { label: "出让金额", name: "F_TransferAmount", width: 80, align: "center" },
                    //{
                    ...
                    { label: "合同名称", name: "F_ContractName", width: 130, align: "center" },
                    { label: "宗地地址", name: "F_ParcelAddress", width: 180, align: "center" },                   
                    {
